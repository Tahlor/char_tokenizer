...
if __name__ == "__main__":
    ...
    vocab = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ,.[UNK]"
    tokenizer = CharacterTokenizer(vocab, model_max_length=128)

    # Testing the _batch_encode_plus function
    batch_texts = ["Hello", "World"]
    batch_encoding = tokenizer._batch_encode_plus(batch_texts)
